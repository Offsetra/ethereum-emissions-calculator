...
describe("constructEtherscanURL", () => {
  test("constructs valid string with default params", () => {
    const valid =
      "https://api.etherscan.io/api?action=txlist&module=account&sort=desc&address=0x063dd253c8da4ea9b12105781c9611b8297f5d14&startBlock=0&endBlock=99999999&apikey=test-api-key";
    ...
    expect(constructEtherscanURL(options)).toContain("&sort=desc");
